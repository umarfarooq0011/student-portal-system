                        ...
                        <h2 class="text-xl font-bold text-slate-800">
                            ...
                            switch($currentPage) {
                                case 'index.php':
                                    echo 'Dashboard';
                                    break;
                                case 'manage_announcements.php':
                                    echo 'Announcements';
                                    break;
                                case 'manage_assignments.php':
                                    echo 'Assignments';
                                    break;
                                case 'manage_timetable.php':
                                    echo 'Timetables';
                                    break;
                                case 'view_submissions.php':
                                    echo 'Submissions';
                                    break;
                                case 'profile.php':
                                    echo 'Profile';
                ...
                <div class="flex items-center gap-4">
                    ...
                    <div class="relative" id="userDropdownContainer">
                        ...
                        <button class="flex items-center gap-3 px-4 py-2.5 rounded-xl bg-slate-100 hover:bg-slate-200 transition-all" id="userDropdownBtn">
                            ...
                            <?php else: ?>
                                <div class="w-8 h-8 rounded-lg bg-sky-600 flex items-center justify-center text-white font-semibold text-sm">
                                    <?php echo strtoupper(substr($_SESSION['full_name'], 0, 1)); ?>
                                </div>
                            <?php endif; ?>
                            <div class="hidden sm:block text-left">
                                <p class="text-sm font-semibold text-slate-700"><?php echo isset($_SESSION['full_name']) ? $_SESSION['full_name'] : 'Admin'; ?></p>
                        ...
                        <div class="absolute right-0 mt-2 w-56 bg-white rounded-2xl shadow-xl border border-slate-200 py-2 hidden" id="userDropdownMenu">
                            <div class="px-4 py-3 border-b border-slate-100">
                                ...
                                <p class="text-xs text-slate-500"><?php echo $_SESSION['email'] ?? 'admin@portal.com'; ?></p>
                            </div>
                            <a href="../admin/profile.php" class="flex items-center gap-3 px-4 py-2.5 text-sm text-slate-600 hover:bg-slate-50 transition-all">
